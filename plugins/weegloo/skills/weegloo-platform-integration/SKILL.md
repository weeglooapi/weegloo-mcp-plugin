...
- **`weegloo-frontend`** — the page or app code this router's plan turns into: root-absolute asset
  ...
  skill's own `weegloo-frontend/references/maps-embed.md` (every mode's parameters, localization, a multi-place store
